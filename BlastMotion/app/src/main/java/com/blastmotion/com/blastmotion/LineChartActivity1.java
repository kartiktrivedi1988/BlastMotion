...
public class LineChartActivity1 extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timestamp = getIntent().getStringArrayListExtra("X");
        sweepSpeed = getIntent().getStringArrayListExtra("Y");
...
//        setData(mSeekBarX.getProgress() + 1, mSeekBarY.getProgress());
    ...
    private void setData() {
        ...
        for (int i = 0; i < timestamp.size(); i++) {
            String dateString = timestamp.get(i);
            ...
            try {
                ...
                xVals.add(mMonths[calendar.get(Calendar.MONTH)-1]);
        ...
        for (int i = 0; i < sweepSpeed.size(); i++) {

            try{
                yVals.add(new Entry(Float.parseFloat(sweepSpeed.get(i)), i));
            }catch ( Exception e){
                e.printStackTrace();
                yVals.add(new Entry(11f, i));
            }
